...
public class GestionVentas {
    ...
    //registrar venta
    public Venta registrarVenta(Cliente cliente, String metodoPago, String referenciaPago) {
        ...
        // Enviar correo en hilo separado en hilo
    ...
    //generacion del ticket de la venta
    public void generarTicketTXT(Venta v) {
        ...
        try (PrintWriter pw = new PrintWriter(new FileWriter(ruta))) {
            ...
            pw.println("---------------------------------------");
            pw.println("        Gracias por tu compra  ");
            pw.println("---------------------------------------═");
        } catch (IOException e) {
    ...
    final String REMITENTE = "ferhdz.06f@outlook.com";
    ...
    try {
        javax.mail.Session session = javax.mail.Session.getInstance(props,
            ...
            msg.setFrom(new javax.mail.internet.InternetAddress(REMITENTE));
            msg.setRecipients(javax.mail.Message.RecipientType.TO,
                javax.mail.internet.InternetAddress.parse(v.getEmailCliente()));
            msg.setSubject("Tu compra en AmazonasFake — Folio " + v.getFolio());
            ...
            System.out.println("Correo no enviado: " + e.getMessage());
        }
    }

    private void iniciarSeguimiento(Venta venta) {
        Thread hilo = new Thread(() -> {
            // Intervalos 2 min, 5 min, 10 min, 15 min
            ...
            while (i < intervalos.length) {
                ...
                guardarVentas(); 
                System.out.println("Pedido " + venta.getFolio() + venta.getEstado().getEtiqueta());
                if (!sigue) break;
                i++;
            }
        });
