...
public javax.swing.JLabel getBtnEliminar() { return lblEliminar; }
    ...
    private void initComponents() {
        ...
        add(lblNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 350, -1));
        ...
        add(lblCategoria, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, 190, 20));

        lblPrecio.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        lblPrecio.setForeground(new java.awt.Color(65, 20, 60));
        lblPrecio.setText("precio");
        add(lblPrecio, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, 190, -1));

        lblEliminar.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        lblEliminar.setText("🗑");
        lblEliminar.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        add(lblEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 30, -1, -1));
